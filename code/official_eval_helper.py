...
from data_batcher import padded, Batch, tokens_to_char_ids
...
def get_batch_generator(word2id, char2id, qn_uuid_data, context_token_data, qn_token_data, batch_size, context_len, question_len, word_len):
    ...
    while True:
        ...
        batch = Batch(context_ids, context_mask, context_char_ids, context_char_mask, context_tokens, qn_ids, qn_mask, qn_char_ids, qn_char_mask, qn_tokens=None, ans_span=None, ans_tokens=None, uuids=uuids)
