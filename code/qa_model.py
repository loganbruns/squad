...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        # small_attn_output = tf.contrib.layers.fully_connected(attn_output, num_outputs=self.FLAGS.hidden_size) # small_attn_output is shape (batch_size, context_len, hidden_size)
